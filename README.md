...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/iacs-ipac-reader-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15362&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/iacs-ipac-reader-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `iacs-ipac-reader` can be installed with:

```
conda install iacs-ipac-reader
```

It is possible to list all of the versions of `iacs-ipac-reader` available on your platform with:
